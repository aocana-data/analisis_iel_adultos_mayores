...
class DataCleaner:
    ...
    def set_validadores_exactitud(self , path_funciones:Optional[str] = None):
        ...
        try:
            ...
            exec(data)
            rules_set = collapser(self.config.get('exactitud_reglas', None)) 
    ...
    def get_exactitud(self)->any:
        ...
        if self.rules is None or len(self.rules) == 0:
            ...
            self.rules = collapser({x["columna"]:x.get('default') for x  in self.data_columnas()})
    ...
    def to_csv(self,**kwargs):
        ...
        file = kwargs.get('file_name' , 'resumen_output')
